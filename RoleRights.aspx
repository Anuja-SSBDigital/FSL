<%@ Page Title="Role Rights" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RoleRights.aspx.cs" Inherits="Home" %>
                            ...
                            <td>
                                <table>
                                    ...
                                    <tr class="tr-shadow">
                                        <td>
                                            <label class="au-checkbox">
                                                <input type="checkbox" value="EditEvidence" id="chkEditEvidence" runat="server" />
                                                <span class="au-checkmark"></span>
                                            </label>
                                        </td>
                                        <td>Edit Evidence Acceptance</td>
                                    </tr>
                                      <tr class="spacer"></tr>
                                    <tr class="tr-shadow">
                                        <td>
                                            <label class="au-checkbox">
                                                <input type="checkbox" value="EvidenceAcceptance" id="chkEvidenceAcceptance" runat="server" />
                                                <span class="au-checkmark"></span>
                                            </label>
                                        </td>
                                        <td>Evidence Acceptance</td>
                                    </tr>
                                    <tr class="spacer"></tr>
                                    <tr class="tr-shadow">
                                        <td>
                                    ...
                                    <tr class="tr-shadow">
                                        <td>
                                            <label class="au-checkbox">
                                                <input type="checkbox" value="HDDetails" id="chkHDDetails" runat="server" />
                                                <span class="au-checkmark"></span>
                                            </label>
                                        </td>
                                        <td>Hard Drive Details</td>
                                    </tr>--%>
                                    <tr class="spacer"></tr>
                                    <tr class="tr-shadow">
                                        <td>
                                    ...
                                    <tr class="tr-shadow">
                                        <td>
                                            <label class="au-checkbox">
                                                <input type="checkbox" value="AddCaseDetails" id="chkAddCaseDetails" runat="server" />
                                                <span class="au-checkmark"></span>
                                            </label>
                                        </td>
