        ...
        _initPreviewCache: function () {
            ...
            self.previewCache = {
                ...
                footer: function (i, isDisabled, size) {
                    ...
                    a = self._renderFileActions(false, sDwl, false, sZm, sDrg, dis, url, key, true, dUrl, dFil);
        ...
        _renderFileFooter: function (caption, size, width, isError) {
            ...
            if (self.isAjaxUpload) {
                out = template.setTokens({
                    'actions': self._renderFileActions(upl, false, false, zoom, drg, false, false, false),
                    'caption': caption,
                    'size': size,
                    'width': width,
                    'progress': self._renderThumbProgress(),
