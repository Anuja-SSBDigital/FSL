<%@ Page Title="Department" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" 
    CodeFile="DeptMaster.aspx.cs" Inherits="Home" %>
        ...
        <div class="card-body card-block">
            <div class="col-sm-8 form-horizontal">
                ...
                <div class="row form-group">
                    ...
                    <asp:Button ID="btnAddDept" runat="server" Text="Add" CssClass="btn btn-dark btn-block" OnClientClick="return val();"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Action" ItemStyle-Width="17%">
                                <ItemTemplate>
                                    ...
                                    <button type="button" class="btn btn-icons btn-rounded btn-outline-danger " title="Delete"
