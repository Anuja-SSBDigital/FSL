    ...
    <div class="head-bg-content ">
                ...
                <form runat="server">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtPass" runat="server"
                            CssClass="au-input au-input--full" TextMode="Password"></asp:TextBox>
                    </div>
                    ...
                    <asp:Button ID="btnLogin" runat="server" Text="Login"
                        CssClass="au-btn au-btn--block au-btn--green m-b-20" OnClick="btnLogin_Click" />
                    <a href="forgotpassword.aspx"><b>Forgot Password?</b></a>
                    <%-- <div class="form-group">
        ...
        <div class="bg-white col-md-12 navbar-fixed-bottom">
            <div class="copyright" style="padding: 13px 0; width: 30%; margin: auto;">
                ...
                <%--<img src="images/ssb_Digital-2.png" alt="DFS" />--%>
            </div>
        </div>
    </div>
