...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="card">
        <div class="card-header">
            <strong>
                <asp:Label ID="lblTitle" runat="server">Edit User</asp:Label>
            </strong>
        </div>
        <div class="card-body card-block">
            <div class="col-sm-12 form-horizontal">
                ...
                <div class="form-group m-t-30">
                    <asp:Button ID="btnCreate" OnClientClick="return val();" OnClick="btnCreate_Click" runat="server" Text="Update" CssClass="btn btn-dark btn-block" />
                </div>
                <hr />
                 <strong>
                <asp:Label ID="Label1" runat="server">Reset Password</asp:Label>
            </strong>
                ...
                <div class="row form-group" style="margin-top:20px">
                    <div class="col-sm-6 form-horizontal">
                        ...
                        <label class=" form-control-label">Password</label>
                        <asp:TextBox runat="server" ID="txt_password" CssClass="form-control" Text="Pass@123"></asp:TextBox>
                    </div>

                    <div class="col-sm-6 form-horizontal">
                        <asp:HiddenField ID="HiddenField3" runat="server" />
                        <asp:Button runat="server" ID="btn_reset" OnClick="btn_reset_Click" CssClass="btn btn-primary" Style="margin-top: 30px;" Text="Reset Password" />
                    </div>
                </div>
            </div>
        </div>
