<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ChangeAsigncase.aspx.cs" Inherits="ChangeAsigncase" %>
                ...
                <div class="row justify-content-center" runat="server" id="div_rpt" visible="false">
                    <div class="col-lg-12">
                        ...
                        <div class="card shadow p-4">
                            ...
                            <div class="form-group mb-3" id="user_Div" runat="server" visible="false">
                            ...
                            <div class="form-group mb-3" id="ChangeUser_div" runat="server" visible="false">
                                <label>Changes Assign User</label>
                                <asp:DropDownList ID="ddl_chnageusername" CssClass="form-control" runat="server">
                                </asp:DropDownList>
                            </div>

                            <div class="col-sm-4 form-horizontal" style="margin-top: 30px;">
                                <asp:Button ID="btn_changeUsercaseasign"
                                    runat="server"
                                    Text="Assign"
                                    CssClass="btn btn-primary btn-block"
                                    OnClick="btn_changeUsercaseasign_Click" />
                            </div>
                        </div>
