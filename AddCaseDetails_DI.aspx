<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AddCaseDetails_DI.aspx.cs" Inherits="AddCaseDetails_DI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="card">
        ...
        <div class="card-body card-block">
            <div class="col-12">
               <div class="row form-group" runat="server" id="div_director" >
                    ...
                    <div class="col-sm-4 form-horizontal">
                        <label class=" form-control-label">CaseNo</label>
                   <asp:DropDownList ID="ddlcaseno" OnSelectedIndexChanged="ddlcaseno_SelectedIndexChanged" AutoPostBack="true" CssClass="form-control" runat="server"></asp:DropDownList>
                      ...
                      <div class="col-sm-4 form-horizontal">
                     <asp:LinkButton ID="lnkdir_search" runat="server"
                        CssClass="au-btn au-btn--submit m-t-30" OnClick="lnkdir_search_Click">
            ...
            <div class="col-12 m-t-20" id="divcd" runat="server" visible="false">
                ...
                <div class="m-t-40">
                    <asp:Button ID="btnInsert" Visible="false" runat="server" Text="Insert"
