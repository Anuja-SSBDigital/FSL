<%@ Page Title="Role Master" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RoleMaster.aspx.cs" Inherits="Home" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="table-responsive table--no-card">
                    <asp:GridView ID="GrdRole" runat="server" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="roledesc" HeaderText="Role Desc" ItemStyle-Width="25%"></asp:BoundField>
    ...
    <script>
        function val() {
            ...
            if (txtDesc.value == "") {
                txtDesc.classList.add('is-invalid');
                return false;
            } else {
                txtDesc.classList.remove('is-invalid');
            }
                ...
                success: function (res) {
                    ...
                    if (!res.d.startsWith("Error")) {
                        ...
                        if (jb.length > 0) {
                            ...
                            document.getElementById("<%=txtDesc.ClientID %>").value = jb[0].roledesc;
