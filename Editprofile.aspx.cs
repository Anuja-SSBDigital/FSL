...
public partial class Editprofile : System.Web.UI.Page
{
    ...
    public void getuserdetails()
    {
        ...
        string res = fl.GetUseridwise(userid);
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            ddlRole.Text = dt.Rows[0]["role_id"].ToString();
            ddlDiv.Text = dt.Rows[0]["div_id"].ToString();
            ddlInst.Text = dt.Rows[0]["inst_id"].ToString();
            ddlDep.Text = dt.Rows[0]["dept_id"].ToString();

            txt_mob.Text = dt.Rows[0]["mobileno"].ToString();

            //txt_appointmentletter.Attributes["class"] = "form-control";
    ...
    public void fillddl()
    {
        try
        {
            ...
            string resdiv = fl.GetDivById(ddlDep.SelectedValue);
            if (!resdiv.StartsWith("Error"))
            {
                DataTable dt = fl.Tabulate(resdiv);
                if (dt.Rows.Count > 0)
                {
        ...
        if (Session["userid"] != null)
        {
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["userid"] != null && Request.QueryString["userid"].ToString() != "")
                {
                    ...
                    getuserdetails();
                    fillddl();
                    txt_password.Attributes.Add("disabled", "disabled");
        ...
        else
        {
            if (Appoi_hash != "" || Promo_hash != "")
            {
                ...
                else
                {
                    if (hdnUserID.Value != "")
                    {
                        res = fl.UpdateUser(userid, txtFN.Text, txtLN.Text,
                    txtUN.Text, txtDes.Text, ddlInst.SelectedValue, ddlDep.SelectedValue,
                    ...
                    if (!res.StartsWith("Error"))
                    {
                        ...
                        if (dtdata.Rows.Count > 0)
                        {
                            ...
                            "alert", "<script>alert('User Updated Successfully.');window.location='Userlist.aspx';</script>");
                                }
                            ...
                            else
                            {
                                ...
                                {
                                    ClientScript.RegisterStartupScript(this.GetType(), "alert",
                           "<script>alert('User Does not Updated Successfully ');</script>");
                                }
    ...
    protected void btn_reset_Click(object sender, EventArgs e)
    {
        ...
        string userid = Request.QueryString["userid"].ToString();
        string pass = fl.EncryptString(txt_password.Text);
        string res = fl.ResetPassword(userid, pass);
        if (!res.StartsWith("Error"))
        {
        ...
        {
            Response.Write("<script>alert('Password not Reset Successfully')</script>");
