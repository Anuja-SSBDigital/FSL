<%@ Page Title="Division Master" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DivMaster.aspx.cs"
     Inherits="Home" %>
        ...
        <div class="card-body card-block">
            <div class="col-sm-8 form-horizontal">
                ...
                <div class="row form-group">
                    ...
                    <asp:Button ID="btnAddDiv" runat="server" Text="Add" CssClass="btn btn-dark btn-block" OnClientClick="return val();"
